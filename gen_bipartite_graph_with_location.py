    ...
    for fn in alg_fn_list:
        ...
        for item in dist_list:
            if item[2] < thresh:
                ...
                # Check whether the signature has location for each signature. If they both have 
                # then check whether the locations are the same. If so, then 
                # append them to the edge_list as above. Otherwise, do nothing. 
                pass
        fi.close()
    print(slot_idx)
    # pp(edge_list)
